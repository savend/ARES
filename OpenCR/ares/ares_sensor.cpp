...
void AresSensor::initIMU(void)
{
  imu_.begin();
}

void AresSensor::updateIMU(void)
{
  imu_.update();
}

void AresSensor::calibrationGyro()
{
  uint32_t pre_time;
  uint32_t t_time;
...
sensor_msgs::Imu AresSensor::getIMU(void)
{
...
float* AresSensor::getOrientation(void)
{
...
sensor_msgs::MagneticField AresSensor::getMag(void)
{
...
float AresSensor::checkVoltage(void)
{
  float vol_value;
...
uint8_t AresSensor::checkPushButton(void)
{
  return getPushButton();
}

void AresSensor::melody(uint16_t* note, uint8_t note_num, uint8_t* durations)
{
...
void AresSensor::makeSound(uint8_t index)
{
...
void AresSensor::initBumper(void)
{
  ollo_.begin(3, TOUCH_SENSOR);
  ollo_.begin(4, TOUCH_SENSOR);
}

uint8_t AresSensor::checkPushBumper(void)
{
...
void AresSensor::initIR(void)
{
  ollo_.begin(2, IR_SENSOR);
}

float AresSensor::getIRsensorData(void)
{
...
void AresSensor::initSonar(void)
{
...
void AresSensor::updateSonar(uint32_t t)
{
...
float AresSensor::getSonarData(void)
{
  float distance = 0.0;
...
float AresSensor::getIlluminationData(void)
{
  uint16_t light;
...
void AresSensor::setLedPattern(double linear_vel, double angular_vel)
{
