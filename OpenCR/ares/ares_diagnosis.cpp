...
void AresDiagnosis::showLedStatus(bool isConnected)
{
...
void AresDiagnosis::updateRxTxLed(void)
{
...
uint8_t AresDiagnosis::getButtonPress(uint16_t time_to_press)
{
