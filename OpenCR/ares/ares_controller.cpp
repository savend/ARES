...
bool AresController::init(float max_lin_vel, float max_ang_vel, uint8_t scale_lin_vel, uint8_t scale_ang_vel)
{
...
bool AresController::getRCdata(float *get_cmd_vel)
{
